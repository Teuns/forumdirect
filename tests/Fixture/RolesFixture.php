...
class RolesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'alias' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'description' => 'Test',
                'alias' => 'user',
                'created' => '2019-12-23 13:00:59',
                'modified' => '2019-12-23 13:00:59'
            ],
        ];
        parent::init();
    }
